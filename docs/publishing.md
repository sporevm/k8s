...
```text
ghcr.io/sporevm/k8s-runtime:0.1.4
```

Public runtime images should publish to GHCR:

```bash
export SPOREVM_K8S_RUNTIME_IMAGE=ghcr.io/sporevm/k8s-runtime:0.1.4
...
```text
oci://ghcr.io/sporevm/charts/sporevm-k8s --version 0.1.4
```

```bash
helm registry login ghcr.io
mise run chart:package
helm push dist/charts/sporevm-k8s-0.1.4.tgz oci://ghcr.io/sporevm/charts
```
